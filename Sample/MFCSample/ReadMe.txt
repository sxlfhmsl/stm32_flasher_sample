...
MFCSample application intends to ilustrate how to call the DLLs delivered within the
STVP package from a MFC based application.
...
========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : MFCSample
========================================================================


AppWizard has created this MFCSample application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MFCSample application.
...
MFCSample.h
    ...
    CMFCSampleApp application class.
...
MFCSampleDlg.h, MFCSampleDlg.cpp - the dialog
    These files contain your CMFCSampleDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in MFCSample.rc, which can be edited in Microsoft
	Visual C++.
...
============================================
      Compiler used to build MFCSample :
============================================
MFCSample was developped with Microsoft Visual C++ 6.0. Using another compiler 
will probably entail some modifications.

  
===========================================
      Files required to run MFCSample :
===========================================
To execute MFCSample, the following files should be added in MFCSample directory :
. All the DLLs that are provided within STVP package
. the dbcfile.cnf and tools.cnf configuration files
. the .s19 and .bin files that are delivered within the STVP distribution. 
